This repository has been created from the Symfony Demo Application to investigate a bug in Google Cloud Spanner. Please have a look at [this](spanner-emulator-bug.md) file.
